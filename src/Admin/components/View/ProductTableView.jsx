...
import { deleteOrder,findProducts } from "../../../State/Admin/Order/Action";
  ...
  const ProductsTableView = () => {
    ...
    return (
      <div className="">
        <Box width={"100%"}>
          <Card className="p-3">
            <CardHeader title="Sort" sx={{ pt: 0, alignItems: "center", "& .MuiCardHeader-action": { mt: 0.6 }, }} />
                  ...
                  {[1, 1, 1, 1, 1].map((item) => (
                    ...
                    >
                      <TableCell>
                        {" "}
                        <Avatar
                        // alt={item.titel} src={item.imageUrl}
                        />{" "}
                      </TableCell>
                      ...
                      <TableCell sx={{ textAlign: "center" }}>minDiscount price</TableCell>
                      <TableCell sx={{ textAlign: "center" }}>quantity</TableCell>
                      <TableCell sx={{ textAlign: "center" }}>
                        <Button variant="text">Update</Button>
                      </TableCell>
                      <TableCell sx={{ textAlign: "center" }}>
                        <Button onClick={() => handleDeleteProduct(23)} variant="text" >Delete</Button>
                      </TableCell>
                    </TableRow>
                  ))}
